...
public class GameManager : MonoBehaviour
{
    ...
    private void MainMenu()
    {
        ...
        uiController.ShowButton("Bắt đầu");
    ...
    private void EndGame()
    {
        ...
        {
            uiController.ShowBanner("Bạn đã thắng!");
        }
        else
        {
            uiController.ShowBanner("Tác tử học máy đã thắng!");
        }

        // Update button text
        uiController.ShowButton("Trở về màn hình chính");
    }
